...
public class Map extends TableImpl<MapRecord> {
    ...
    private static final long serialVersionUID = -1751709730;
     ...
     */
    public final TableField<MapRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
