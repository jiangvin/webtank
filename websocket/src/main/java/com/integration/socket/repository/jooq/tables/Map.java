...
public class Map extends TableImpl<MapRecord> {
    ...
    /**
     * The column <code>map.width</code>.
     */
    public final TableField<MapRecord, Integer> WIDTH = createField("width", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>map.height</code>.
     */
    public final TableField<MapRecord, Integer> HEIGHT = createField("height", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MAP_NAME_UNIQUE, Indexes.MAP_PRIMARY);
    }
    ...
    public List<UniqueKey<MapRecord>> getKeys() {
        return Arrays.<UniqueKey<MapRecord>>asList(Keys.KEY_MAP_PRIMARY, Keys.KEY_MAP_NAME_UNIQUE);
    }
