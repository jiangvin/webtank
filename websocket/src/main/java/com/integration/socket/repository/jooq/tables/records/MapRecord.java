...
public class MapRecord extends UpdatableRecordImpl<MapRecord> implements Record6<String, String, Timestamp, Timestamp, String, String> {

    private static final long serialVersionUID = 998942187;
     ...
     */
    @Override
    public Row6<String, String, Timestamp, Timestamp, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, String, Timestamp, Timestamp, String, String> valuesRow() {
     ...
     */
    @Override
    public MapRecord values(String value1, String value2, Timestamp value3, Timestamp value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MapRecord(String id, String data, Timestamp createTime, Timestamp updateTime, String secret, String name) {
        super(Map.MAP);
