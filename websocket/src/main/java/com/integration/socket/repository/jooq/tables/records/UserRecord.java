...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record13<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer> {

    private static final long serialVersionUID = -1320934824;
     ...
     */
    @Override
    public Row13<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row13<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public UserRecord values(String value1, String value2, String value3, Timestamp value4, Timestamp value5, Integer value6, Timestamp value7, Timestamp value8, Timestamp value9, String value10, Timestamp value11, Integer value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String userId, String username, String userDevice, Timestamp createTime, Timestamp lastLoginTime, Integer coin, Timestamp ghostExpired, Timestamp clockExpired, Timestamp redStarExpired, String tankType, Timestamp tankTypeExpired, Integer singleGameTimes, Integer netGameTimes) {
        super(User.USER);
