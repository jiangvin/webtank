...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record15<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 316782671;
     ...
     */
    @Override
    public Row15<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row15<String, String, String, Timestamp, Timestamp, Integer, Timestamp, Timestamp, Timestamp, String, Timestamp, Integer, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public UserRecord values(String value1, String value2, String value3, Timestamp value4, Timestamp value5, Integer value6, Timestamp value7, Timestamp value8, Timestamp value9, String value10, Timestamp value11, Integer value12, Integer value13, Integer value14, Integer value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
