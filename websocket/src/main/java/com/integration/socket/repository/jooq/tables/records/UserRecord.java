...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record8<String, String, String, Timestamp, Timestamp, Integer, Integer, Integer> {

    private static final long serialVersionUID = -1131736838;
     ...
     */
    @Override
    public Row8<String, String, String, Timestamp, Timestamp, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, String, String, Timestamp, Timestamp, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public UserRecord values(String value1, String value2, String value3, Timestamp value4, Timestamp value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String userId, String username, String userDevice, Timestamp createTime, Timestamp lastLoginTime, Integer coin, Integer singleGameTimes, Integer netGameTimes) {
        super(User.USER);
