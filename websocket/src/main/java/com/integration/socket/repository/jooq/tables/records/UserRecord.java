...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record6<String, String, String, Timestamp, Timestamp, Integer> {

    private static final long serialVersionUID = 1525761810;
     ...
     */
    @Override
    public UserRecord values(String value1, String value2, String value3, Timestamp value4, Timestamp value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String userId, String username, String userDevice, Timestamp createTime, Timestamp lastLoginTime, Integer coin) {
        super(User.USER);
